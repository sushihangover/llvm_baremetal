...
void Reset_Handler(void) {
    ...
    main();
    //svcPrint((int)&"Main returned!?\n");
}

//******************************************************
// Processor receives a fault, debug stack
//******************************************************
void HardFault_Handler(void)
{
    //svcPrint((int)&"HardFault_Handler\n");
    while(1) { };
}

//******************************************************
// This is a placeholder, should never be entered, debug 
//******************************************************
void Dummy_Handler(void) {
    //svcPrint((int)&"Dummy_Handler\n");
    while (1) { };
}
